...
public class SetRulesProfilesIsBuiltToTrueForDefaultOrganization extends DataChange {
  ...
  public SetRulesProfilesIsBuiltToTrueForDefaultOrganization(Database db) {
    super(db);
  }
