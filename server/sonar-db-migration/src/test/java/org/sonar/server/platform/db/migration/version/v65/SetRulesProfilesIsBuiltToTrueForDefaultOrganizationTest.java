...
public class SetRulesProfilesIsBuiltToTrueForDefaultOrganizationTest {

  @Rule
  public ExpectedException expectedException = ExpectedException.none();

  @Rule
  public CoreDbTester db = CoreDbTester.createForSchema(SetRulesProfilesIsBuiltToTrueForDefaultOrganizationTest.class, "initial.sql");

  private SetRulesProfilesIsBuiltToTrueForDefaultOrganization underTest = new SetRulesProfilesIsBuiltToTrueForDefaultOrganization(db.database());
  ...
  public void mark_rules_profiles_of_default_org_as_built_in() throws SQLException {
    ...
    IntStream.rangeClosed(1, 3).forEach(i -> {
      insertRulesProfile(defaultOrganizationUuid, "RP_UUID_" + i, false);
      insertRulesProfile("ORG_UUID_404", "RP_UUID_404_" + i, false);
    });
  ...
  public void reentrant_of_crashed_migration() throws SQLException {
    ...
    String defaultOrganizationUuid = "ORG_UUID_1";
    setDefaultOrganization(defaultOrganizationUuid);
    insertRulesProfile(defaultOrganizationUuid, "RP_UUID_1", true);
    insertRulesProfile(defaultOrganizationUuid, "RP_UUID_2", false);
    insertRulesProfile(defaultOrganizationUuid, "RP_UUID_3", false);
  ...
  public void fail_if_no_default_org_and_org_activated() throws SQLException {
    enableOrganization();
    insertRulesProfile("ORG_UUID_1", "RP_UUID_1", false);
  ...
  private void insertRulesProfile(String orgUuid, String rulesProfileUuid, boolean isBuiltIn) {
