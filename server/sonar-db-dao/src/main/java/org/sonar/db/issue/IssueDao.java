...
public class IssueDao implements Dao {
   ...
   * <p>Results may be in a different order as input keys (see {@link #selectByOrderedKeys(DbSession, Collection)}).</p>
   */
   ...
   */
  public List<IssueDto> selectByOrderedKeys(DbSession session, Collection<String> keys) {
